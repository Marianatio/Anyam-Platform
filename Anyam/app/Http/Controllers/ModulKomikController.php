...
class ModulKomikController extends Controller
{
    ...
    public function getdatamodulkomik()
{
    $response = Http::get('https://anyam-a0fcb-default-rtdb.firebaseio.com/Anyam/modul_komik.json');
...
public function postdatamodulkomik(Request $request)
{
    // Ambil data yang diterima dari formulir atau sumber lain
    $postData = $request->all();

    // Kirim data ke Firebase API
    $response = Http::post('https://anyam-a0fcb-default-rtdb.firebaseio.com/Anyam/modul_komik.json', [
        'data' => $postData,
    ]);
...
public function deletedatamodulkomik(Request $request)
{
    ...
    $deleteUrl = "https://anyam-a0fcb-default-rtdb.firebaseio.com/Anyam/modul_komik/{$dataId}.json";
