...
class LaporankekerasanSeksualController extends Controller
{
...
public function getdatalaporankekerasanseksual()
{
    $response = Http::get('https://anyam-a0fcb-default-rtdb.firebaseio.com/Anyam/laporan_kekerasan_seksual.json');
...
public function postdatalaporankekerasanseksual(Request $request)
{
    // Ambil data yang diterima dari formulir atau sumber lain
    $postData = $request->all();

    // Kirim data ke Firebase API
    $response = Http::post('https://anyam-a0fcb-default-rtdb.firebaseio.com/Anyam/laporan_kekerasan_seksual.json', [
        'data' => $postData,
    ]);
...
public function deletedatalaporankekerasanseksual(Request $request)
{
    ...
    $deleteUrl = "https://anyam-a0fcb-default-rtdb.firebaseio.com/Anyam/laporan_kekerasan_seksual/{$dataId}.json";
