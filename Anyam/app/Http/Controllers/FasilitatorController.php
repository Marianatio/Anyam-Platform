...
public function getdatafasilitator()
{
    $response = Http::get('https://anyam-a0fcb-default-rtdb.firebaseio.com/Anyam/fasilitator.json');
...
public function postdatafasilitator(Request $request)
{
    // Ambil data yang diterima dari formulir atau sumber lain
    $postData = $request->all();

    // Kirim data ke Firebase API
    $response = Http::post('https://anyam-a0fcb-default-rtdb.firebaseio.com/Anyam/fasilitator.json', [
        'data' => $postData,
    ]);
...
public function deletedatafasilitator(Request $request)
{
    ...
    $deleteUrl = "https://anyam-a0fcb-default-rtdb.firebaseio.com/Anyam/fasilitator/{$dataId}.json";
